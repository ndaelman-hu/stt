...
echo ""
echo "Technical vocabulary:"
echo "  Copy vocab.example.txt to vocab.txt, add your domain terms, and set"
echo "  VOCAB_FILE=vocab.txt in .env to improve recognition of jargon."
echo ""
